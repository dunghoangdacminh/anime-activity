	...
	return (
		<div className="min-h-screen bg-black text-white">
					...
					<div className="relative w-full max-w-sm">
						<form onSubmit={handleSearch}>
							...
							<Input
								...
								className="border-gray-700 bg-gray-900 pl-8 focus:border-purple-500"
								value={searchKeyword}
			...
			<main className="container py-6">
					...
					<>
						...
						{animeData?.spotlights && animeData.spotlights.length > 0 && (
							<section className="mb-12">
								<AnimeSpotlight spotlights={animeData.spotlights} onAnimeClick={handleAnimeClick} />
							</section>
						)}
						...
						{animeData?.trending && animeData.trending.length > 0 && (
							<section className="mb-12">
								...
								<AnimeTrending trending={animeData.trending} onAnimeClick={handleAnimeClick} />
							</section>
						)}
						...
						{animeData?.today && animeData.today.schedule && (
							<section className="mb-12">
								...
								<AnimeSchedule schedule={animeData.today.schedule} onAnimeClick={handleAnimeClick} />
							</section>
						)}
							...
							<section className="mb-12">
								...
								<div className="flex flex-wrap gap-2">
									{animeData.genres.map((genre: string) => (
										<Badge key={genre} variant="outline" className="cursor-pointer bg-gray-800 hover:bg-gray-700">
											{genre}
										</Badge>
									))}
								</div>
				...
				{/* Anime Details Modal */}
				<AnimeDetailsModal animeId={selectedAnimeId} isOpen={isDetailsModalOpen} onClose={handleCloseDetailsModal} />
			</main>
		</div>
	)
}
...
function LoadingState() {
	return (
		<>
			...
			{/* Trending Loading */}
			<div className="mb-12">
				<Skeleton className="mb-4 h-8 w-48 bg-gray-800" />
			...
			{/* Tabs Loading */}
			<div className="mb-12">
				<Skeleton className="mb-6 h-10 w-full bg-gray-800" />
				<div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
